class Siskel
  #
  # To inspect a video or audio file, call Siskel.inspect with a file location.
  # 
  #   results = Siskel.review(:file => 'path/to/myfile.mov')
  # 
  # This will return a hash of result attributes.
  #
  ...
  class << self
    def review(options = {})
      ...
      parse_results(options[:raw_response] || mediainfo_inspect(options[:file]))
    end
